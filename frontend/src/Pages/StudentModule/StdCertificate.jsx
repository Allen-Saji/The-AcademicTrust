...
import './css/stdCertificate.css'
const StdCertificate = ()=>{
    return(
        <React.Fragment>
        ...
        <div className="Certificatemainheader">
            ...
            <h4 className="apjheading">APJ ABDUL KALAM TECHNOLOIGICAL <br />UNIVERSITY</h4>
            <p className="apjbelowheading">Bachelor of Technology Degree Examination</p>
        </div>
        ...
        <div className="certificatetablebody">
            <h4 class="certificatetablebodyheading1">Bachelor of Technology Degree Certificate</h4>
            ...
            <div class="studentinfotablebody">
                <table class="studentinfotable">
                    ...
                    <tr class="studenttableinforow">
                        <td class="studenttableinforow">Month and Year of Passing:</td>
            ...
            <div class="resulttablemain">
                ...
                <h4 class="bottomhead">Student Activity 2 credits(non-academic) successfully completed</h4>
            </div>
        </div>
